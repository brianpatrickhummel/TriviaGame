...
var correct;
var triviaGame = [{
		question: "HOW MANY COLORS ARE THERE ON A RUBIK'S CUBE ?",
		answer: ["5", "6", "7", "4"],
		correct: "1",
	...
	},
	{
		...
		answer: [
			"8,600 MILES per SECOND",
			"86,000 MILES per SECOND",
			"186,000 MILES per SECOND",
			"886,000 MILES per SECOND"
		],
		correct: "2",
		image: "assets//images/lightspeed.jpg"
	},
	{
		question: "APPROXIMATELY HOW LONG DOES IT TAKE FOR SUNLIGHT TO REACH THE EARTH ?",
		answer: ["45 SECONDS", "10 HOURS", "2 HOURS 15 MINUTES", "8 MINUTES"],
		correct: "3",
		image: "assets//images/sunlight.jpg"
	},
	{
		question: "WHAT ELEMENT'S CHEMICAL SYMBOL IS Pb ?",
		answer: ["POTASSIUM", "STRONTIUM", "LEAD", "PALLADIUM"],
		correct: "2",
		image: "assets//images/periodictable.png"
	},
	{
		question: "HOW FAST CAN BEES FLY ?",
		answer: ["35 MPH", "15 MPH", "48 MPH", "8 MPH"],
		correct: "1",
		image: "assets/images/bee.png"
	},
	{
		question: "WHAT IS THE MOST ABUNDANT ELEMENT IN THE UNIVERSE ?",
		answer: ["HYDROGEN", "OXYGEN", "HELIUM", "CARBON"],
		correct: "0",
		image: "assets//images/universe.png"
	},
	{
		question: "THE AIR THAT WE BREATHE IS COMPRISED MOSTLY OF WHAT ELEMENT ?",
		answer: ["CARBON", "ARGON", "OXYGEN", "NITROGEN"],
		correct: "3",
...
function loadQandA() {
	...
	for (var i = 0; i < 4; i++) {
		...
		$(".answers").append(
			"<h4 class= answersAll id=" + i + ">" + answer + "</h4>"
		);
	}
	$("h4").click(function () {
		var id = $(this).attr("id");
...
function timer() {
	if (answered === true) {
		...
		timeRemaining--;
		$(".timeRemaining")
			.text("YOU HAVE " + timeRemaining + " SECONDS TO CHOOSE")
			.removeClass("animated pulse infinite");
	}
}
...
function resetRound() {
	$(".answersAll").remove();
	$(".answers").append(
		'<img class=answerImage src="' + triviaGame[indexQandA].image + ' ">'
	); // adds answer image
	...
	if (indexQandA < triviaGame.length) {
		...
		setTimeout(function () {
			...
			$(".answerImage").remove();
			$(".answers").append(
				"<h4 class= answersAll end>CORRECT ANSWERS: " + correctAnswers + "</h4>"
			);
			$(".answers").append(
				"<h4 class= answersAll end>INCORRECT ANSWERS: " +
				incorrectAnswers +
				"</h4>"
			);
			$(".answers").append(
...
$(".startButton").on("click", function () {
	$(".startButton")
		...
		.addClass("animated fadeOutDown"); //manages the Animate.css applied to Start Button
	startGame();
});
